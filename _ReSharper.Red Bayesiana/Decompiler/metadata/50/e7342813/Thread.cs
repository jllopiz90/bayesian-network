...
namespace System.Threading
{
  ...
  public sealed class Thread : CriticalFinalizerObject, _Thread
  {
    ...
    public ThreadPriority Priority { [SecuritySafeCritical, TargetedPatchingOptOut("Performance critical to inline this type of method across NGen image boundaries")] get; [SecuritySafeCritical, TargetedPatchingOptOut("Performance critical to inline this type of method across NGen image boundaries"), HostProtection(SecurityAction.LinkDemand, SelfAffectingThreading = true)] set; }
    /// <summary>
    ...
    /// </returns>
    /// <filterpriority>1</filterpriority>
    public static Thread CurrentThread { [SecuritySafeCritical, TargetedPatchingOptOut("Performance critical to inline across NGen image boundaries"), ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)] get; }
    /// <summary>
    ...
    public bool IsBackground { [SecuritySafeCritical, TargetedPatchingOptOut("Performance critical to inline this type of method across NGen image boundaries")] get; [SecuritySafeCritical, TargetedPatchingOptOut("Performance critical to inline this type of method across NGen image boundaries"), HostProtection(SecurityAction.LinkDemand, SelfAffectingThreading = true)] set; }
    /// <summary>
    ...
    /// </returns>
    /// <filterpriority>2</filterpriority>
    public ThreadState ThreadState { [SecuritySafeCritical, TargetedPatchingOptOut("Performance critical to inline this type of method across NGen image boundaries")] get; }
    /// <summary>
    ...
    public ApartmentState ApartmentState { [SecuritySafeCritical, TargetedPatchingOptOut("Performance critical to inline this type of method across NGen image boundaries")] get; [SecuritySafeCritical, HostProtection(SecurityAction.LinkDemand, SelfAffectingThreading = true, Synchronization = true)] set; }
    /// <summary>
    ...
    public CultureInfo CurrentUICulture { get; [SecuritySafeCritical, HostProtection(SecurityAction.LinkDemand, ExternalThreading = true)] set; }
    /// <summary>
    ...
    public CultureInfo CurrentCulture { get; [SecuritySafeCritical, SecurityPermission(SecurityAction.Demand, ControlThread = true)] set; }
    /// <summary>
    ...
    public string Name { [TargetedPatchingOptOut("Performance critical to inline this type of method across NGen image boundaries")] get; [SecuritySafeCritical, HostProtection(SecurityAction.LinkDemand, ExternalThreading = true)] set; }
  }
}
